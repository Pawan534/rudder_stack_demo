...
const sourceSpecDirectory = 'features/feature-files';  
const jsonTmpDirectory = `features/reports/json/temp/`;
const reportDir = `features/reports/`;
...
exports.config = {
    ...
    onPrepare: () => {
        ...
        if (!fs.existsSync(jsonTmpDirectory)){
            fs.mkdirSync(jsonTmpDirectory, { recursive: true });
        }
